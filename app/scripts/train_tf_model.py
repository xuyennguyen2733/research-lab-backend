...
DATA_DIR = os.path.join(os.path.join(os.path.join(os.getcwd(),'scripts'),'data'), 'hand')
...
num_keypoints = 360 # sum of number of x, y, z coordinates from landmarks being used (in this case, pose and 2 hands)
       
label_map = {label:num for num, label in enumerate(signs)}

sequences, labels = [], []
for sign in signs:
    file_path = os.path.join(DATA_DIR, sign)
